...
# main_application.geometry('')
main_application.title('Mpad text editor')
...
yellow_icon = tk.PhotoImage(file='icon/yellow.png')
monokai_icon = tk.PhotoImage(file='icon/monokai.png')
night_blue_icon = tk.PhotoImage(file='icon/night_blue.png')
color_theme = tk.Menu(main_menu, tearoff=False)

theme_choice = tk.StringVar()
color_icons = (light_default_icon, light_plus_icon, dark_icon, yellow_icon, monokai_icon, night_blue_icon)

color_dict = {
    'Light Default ' : ('#000000', '#ffffff'),
    'Light Plus' : ('#474747', '#e0e0e0'),
    'Dark' : ('#c4c4c4', '#2d2d2d'),
    'Yellow': ('#2d2d2d', '#ffe8e8'),
...
algin_left_btn = ttk.Button(tool_bar, image=align_left_icon)
algin_left_btn.grid(row=0, column=6, padx=5)

##  align center
align_center_icon = tk.PhotoImage(file='icon/align_center.png')
algin_center_btn = ttk.Button(tool_bar, image=align_center_icon)
algin_center_btn.grid(row=0, column=7, padx=5)

## align right
align_right_icon = tk.PhotoImage(file='icon/align_right.png')
algin_right_btn = ttk.Button(tool_bar, image=align_right_icon)
algin_right_btn.grid(row=0, column=8, padx=5)
...
def change_bold():
    ...
    if text_editor.actual()['weight'] == 'normal':
        text_editor.configure(font=(current_font_family, current_font_size, 'bold'))
    if text_editor.actual()['weight'] == 'bold':
...
def change_underline():
    text_property = tk.font.font(font=text_editor['font'])
    if text_editor.actual()['underline'] == 0:
...
def hide_toolbar():
    ...
    if show_toolbar:
        ...
        tool_bar.pack(side=tk.TOP, fill=tk.X)
        text_editor.pack(fill=tk.BOTH, expand=True)
        # status_bar_pack(side=tk.BOTTOM)
        show_toolbar = True
